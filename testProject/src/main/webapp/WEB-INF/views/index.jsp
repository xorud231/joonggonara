...
<body>
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#"><img src="img/translogo.png" width="150px"></a>
            </div>
            <!-- Collect the nav links, forms, and other content for toggling -->
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    <li>
                        <a href="#" onclick="buy()">팝니다</a>
					</li>
                    <li>
                        <a href="#" onclick="sell()">삽니다</a>
                    </li>
                    <li>
                        <a href="#" onclick="myPage()">My page</a>
                    </li>
                    <li>
                        <a href="gomain.do" >Logout</a>
                    </li>
                </ul>
            </div>
            <!-- /.navbar-collapse -->
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-3" id="3_sell" style="display:none">
                <p class="lead">삽니다</p>
                <div class="list-group">
                    <a href="#col-md-9" class="list-group-item">삽니다 카테고리1</a>
                    <a href="#col-md-9" class="list-group-item">삽니다 카테고리2</a>
                    <a href="#col-md-9" class="list-group-item">삽니다 카테고리3</a>
                </div>
            </div>
            <div class="col-md-3" id="myPage" style="display:">
